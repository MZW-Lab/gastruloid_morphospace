function vectorgen_compiled(bra_sheet, gata_sheet, sox_sheet, dapi_sheet, dist_sheet, num_cells, cm5_master,C2_max, C3_max, C4_max, C2_min, C3_min, C4_min, plate_str)
...
%% Binning for Underlying Distribution Via Hist, 50 Bins, With Intensity Normalization
    edge50 = linspace(0, 390, 51); %% x, y, z, Change Z for number of bins, X, Y, for perceived Radius of colony
...
%             mean_C2 = (ex_C2-C2_min)/(C2_max - C2_min);
%             mean_C3 = (ex_C3-C3_min)/(C3_max - C3_min);
%             mean_C4 = (ex_C4-C4_min)/(C4_max - C4_min);
            mean_C2 = ex_C2 - c2_med; 
            mean_C3 = ex_C3 - c3_med; 
            mean_C4 = ex_C4 - c4_med; 
            ...
            [gata_corr,sox_corr,bra_corr] = standard_corr_compiled(mean_C2, mean_C3, mean_C4);
...
writematrix(master_vec, append('Correlation_Per_Plate_Median', plate_str, '.csv'));    